...
| **[`bridges/`](./bridges)** | Fiat ↔ SSDC bridges. Stripe webhook on-ramp + Stripe Treasury off-ramp. **41 unit tests pass standalone** (no chain required). Multi-currency: USD/EUR/GBP/JPY/MXN |
