...
echo -e "        ${B}./stack/stateset demo lifecycle${X} (~120-line escrow walk-through)"
echo -e ""
echo -e "  Recommended (one-time):"
echo -e "    ${B}eval \"\$(./stack/stateset completion bash)\"${X}   tab-complete for 21 subcommands"
echo -e "    ${B}bash scripts/install-hooks.sh${X}                pre-commit fmt + syntax checks"
echo -e ""
echo -e "  Before pushing to your fork:"
echo -e "    ${B}./stack/stateset gates${X}    runs the 5 non-chain CI gates locally"
